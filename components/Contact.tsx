      ...
      <div className="flex flex-col items-center py-20 px-6">
        ...
        <div className="mb-6 w-full md:w-1/3 ">
          ...
          <input type="text" id="username-success"
                 ...
                 placeholder="Sharon Lee" {...register("name")}/>
        </div>
        <div className="mb-6 w-full md:w-1/3">
          ...
          <div className="relative">
            ...
            <input type="text" id="email-address-icon"
                   className={`${errors.email ? "bg-red-50 border-red-500 text-red-900 focus:ring-red-500 focus:border-red-500" : "bg-gray-50 border-gray-300 text-gray-900 focus:ring-blue-500 focus:border-blue-500"} border text-sm rounded-lg  block w-full pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500`}
                   placeholder="123@email.com" {...register("email", { required: true })}/>

          </div>
          {errors.email && <p className="mt-2 text-sm text-red-600 dark:text-red-500">Email is required!</p>}
        </div>
        {/*<div>*/}
        ...
        <button type="submit"
                className="text-white w-full md:w-auto bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-8 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Submit
        </button>
      </div>
    </form>
  )
